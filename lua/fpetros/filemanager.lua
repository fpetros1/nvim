...
M.setup = function()
    ...
    vim.api.nvim_set_hl(0, 'OilHidden', { fg = palette.gray50, bg = palette.bg })
    vim.api.nvim_set_hl(0, 'OilDir', { fg = palette.cyan, bg = palette.bg })
    vim.api.nvim_set_hl(0, 'OilDirIcon', { fg = palette.cyan, bg = palette.bg })
    vim.api.nvim_set_hl(0, 'OilSocket', { fg = palette.lavender, bg = palette.bg })
    vim.api.nvim_set_hl(0, 'OilSocketHidden', { fg = palette.gray50, bg = palette.bg })
    ...
    vim.api.nvim_set_hl(0, 'OilLinkHidden', { fg = palette.gray50, bg = palette.bg })
    ...
    vim.api.nvim_set_hl(0, 'OilFileHidden', { fg = palette.gray50, bg = palette.bg })
    ...
    vim.api.nvim_set_hl(0, 'OilCopy', { fg = palette.khaki, bg = palette.bg })
    vim.api.nvim_set_hl(0, 'OilChange', { fg = palette.yellow, bg = palette.bg })
    vim.api.nvim_set_hl(0, 'OilRestore', { fg = palette.slate, bg = palette.bg })
